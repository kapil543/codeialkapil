{
    ...
    // lool over all the existing posts on the page(when the
    // window loads for the first time) and call the delete post 
    // method on delete link of each,also add AJAX(using the class
